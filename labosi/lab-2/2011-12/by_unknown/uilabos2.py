    ...
    for el1 in c1:
        ...
        if negacija_el1 in c2:
            ...
            if rez not in publicIspodCrte:
                tempSkup.append(rez)
                publicIspodCrte.append(rez)
    RIJECNIK.append([c1,c2,tempSkup])
...
def plResolution0(skup_premisa):
    ...
    while True:
        ...
        lenOdIspodCrte = len(publicIspodCrte)
        for par in parovi:
            if par not in VecRazrjeseni:
                ...
                if [] in publicIspodCrte:
                    ...
                    print "Najveci broj klauzula u memoriji: ", len(publicIspodCrte)
                    printLista(parentClauses)
                    print "- - - - - - - - - - - - -"
                    printLista(publicIspodCrte)
                    print time.time()-start
                    return True
                
        if lenOdIspodCrte == len(publicIspodCrte): return False
        ...
        for par in parovi:
            if par not in VecRazrjeseni:
                ...
                if [] in publicIspodCrte:
                    ...
                    print "========================="
                    print "Broj koraka: ", brojac
                    print "Najveci broj klauzula u memoriji: ", len(publicIspodCrte)+len(parentClauses)
                    printLista(parentClauses)
                    print "- - - - - - - - - - - - -"
                    printLista(publicIspodCrte)
                    print time.time()-start
